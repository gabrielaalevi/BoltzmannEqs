...
class Component(object):
    ...
    def from_dict(label,particleDict):
        # Creates object from a dictionary with the required properties

        newComponent = Component(label, ID, active, g, mass, 
                                 decaywidth, decayproducts, br, 
                                 collision, collisionproducts, sigmaV)
